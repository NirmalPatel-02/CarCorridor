<?php   
    ...
    if($_SERVER['REQUEST_METHOD']== "POST"){
      ...
      if($brand=="Select Brand" ||$fuel == "Select Fuel"){
        echo "<p style='color:Black;background-color:lightcoral;font-family: Arial;font-size:large;border-radius:2px;' id='msg'>Fill All Detail Is Required</p>";
      }
      else{
      $sql ="INSERT INTO `carcorridor`.`sellcars` (`id`, `carname`, `brand`, `price`, `fuel`, `registrationyear`, `carownership`, `km`, `city`, `state`, `mobile`, `img`,`seller`) VALUES (NULL, '$carname', '$brand', '$price', '$fuel', '$ryear', '$carownership', '$km', '$city', '$state', '$mobile', '$folder','$sellerid')";
      mysqli_query($conn,$sql);
      }
    }
    function message(){
      echo '<script>alert("Your Car Is Now On Sale")</script>';
    }
?>
<!DOCTYPE html>
<html>
        ...
        <div id="panel">
          ...
          <a href="trades.php"><button id="trades">Trades</button></a>
              ...
              <form id="sellform" method="post" enctype="multipart/form-data">
                ...
                <input type="number" id="mobile" placeholder="+91" name="mobile" required>
                <br><br>
                <label id="imagetext">Uplode Image</label>  
                <input type="file" name="uploadfile" id="file" required ><br>
                ...
                <button type="submit" id="sellbutton" onclick="message()"> Submit</button>
              </form><br>
