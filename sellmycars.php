<?php   
    ...
    if($_SERVER['REQUEST_METHOD']== "POST"){
      ...
      $sql ="INSERT INTO `carcorridor`.`sellcars` (`id`, `carname`, `brand`, `price`, `fuel`, `registrationyear`, `carownership`, `km`, `city`, `state`, `mobile`, `img`) VALUES (NULL, '$carname', '$brand', '$price', '$fuel', '$ryear', '$carownership', '$km', '$city', '$state', '$mobile', '$folder')";
